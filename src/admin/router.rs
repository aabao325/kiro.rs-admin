...
use super::{
    handlers::{
        ...
        get_cache_force_config, get_credential_balance, get_credential_models, get_current_models,
        ...
        set_cache_force_config, set_client_key_disabled, set_credential_disabled,
...
pub fn create_admin_router(state: AdminState) -> Router {
    ...
    let authenticated = Router::new()
        ...
        .route(
            "/cache-force",
            get(get_cache_force_config).put(set_cache_force_config),
        )
